...
@Composable
fun ResetePasswordScreen(navController: NavController) {
    ...
    LazyColumn(modifier = Modifier.fillMaxSize()) {
        ...
        item {
            ...
            Column(
                ...
                Text(
                    text = "insira o codigo de recuperacao enviado para o email associado a conta.",
                    fontSize = 18.sp
                )
                Spacer(modifier = Modifier.height(16.dp))
                ComponentTextField1(
...
private fun ResetePasswordScreenPreview() {
    ResetePasswordScreen(rememberNavController())
}