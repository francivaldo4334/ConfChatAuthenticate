...
@Composable
fun SendResetePasswordScreen(navController: NavController) {
    ...
    LazyColumn(
        ...
        item {
            ...
            Column(
                ...
                Text(
                    stringResource(R.string.recuperacao_de_senha),
                    fontSize = 24.sp,
                    fontWeight = FontWeight.Bold
                )
                Text(
                    text = stringResource(R.string.insira_o_email_associado_a_sua_conta_e_verifique_sua_caixa_de_entrada),
                    fontSize = 18.sp
                )
            }
...
private fun SendResetePasswordScreenPreview() {
    SendResetePasswordScreen(rememberNavController())
}